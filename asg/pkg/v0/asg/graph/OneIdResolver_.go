...
func (r *TypeToEndpointIdResolver) SetPipe(id NodeId) (*TypeToEndpointIdResolver) {
	r.set("Pipe", id)
...
func (r *TypeToTypeIdResolver) SetPipeRequest(id NodeId) (*TypeToTypeIdResolver) {
	r.set("PipeRequest", id)

	return r
}

func (r TypeToTypeIdResolver) PipeRequest()(NodeId) {
	return r.d["PipeRequest"]
}

func (r *TypeToTypeIdResolver) SetPipeResponse(id NodeId) (*TypeToTypeIdResolver) {
	r.set("PipeResponse", id)
...
func (r *TypeToTypeIdResolver) SetPipeEndpoint(id NodeId) (*TypeToTypeIdResolver) {
	r.set("PipeEndpoint", id)

	return r
}

func (r TypeToTypeIdResolver) PipeEndpoint()(NodeId) {
	return r.d["PipeEndpoint"]
}

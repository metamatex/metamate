...
const (
	DeleteClientAccountsRequestName = "DeleteClientAccountsRequest"
)

type DeleteClientAccountsRequest struct {
    ...
    Select *DeleteClientAccountsResponseSelect `json:"select,omitempty" yaml:"select,omitempty"`

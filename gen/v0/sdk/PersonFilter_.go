...
type PersonFilter struct {
    ...
    Not []PersonFilter `json:"not,omitempty",yaml:"not,omitempty"`
    Note *TextFilter `json:"note,omitempty",yaml:"note,omitempty"`
    Or []PersonFilter `json:"or,omitempty",yaml:"or,omitempty"`

...
type WhateverFilter struct {
    ...
    Not []WhateverFilter `json:"not,omitempty" yaml:"not,omitempty"`
    Or []WhateverFilter `json:"or,omitempty" yaml:"or,omitempty"`

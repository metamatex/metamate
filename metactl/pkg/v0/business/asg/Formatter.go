...
//
//func init() {
//	registry.RegisterHighlighter(Name, HighConstructor)
//}
//
//func HighConstructor(config map[string]interface{}, cache *registry.Cache) (highlight.Highlighter, error) {
//	return simpleHighlighter.NewHighlighter(
//		simpleFragmenter.NewFragmenter(1000),
//		NewFragmentFormatter(),
